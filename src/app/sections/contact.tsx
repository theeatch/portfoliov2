    ...
    <div className="w-full h-screen space-y-10">
      <div className="h-full flex flex-col lg:flex-row px-4 sm:px-8 md:px-12 lg:px-20 xl:px-48 pb-40 font-semibold">
        ...
        <form
          onSubmit={sendEmail}
          ref={form}
          className="h-full sm:h-1/2 my-auto md:h-4/5 lg:w-1/2 bg-slate-700 text-white rounded-xl text-xl flex flex-col gap-8 justify-center p-20"
        >
          <div className="h-1/2 flex-col flex gap-8">
            <span>Dear DH,</span>
            <textarea
              className="bg-transparent border-b-2 border-b-black outline-none h-full"
              name="message"
            />
          </div>
          <div className="h-1/4 flex-col flex">
            <span>My Name:</span>
            <input
              name="from_name"
              type="text"
